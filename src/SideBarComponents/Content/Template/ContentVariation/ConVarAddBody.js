...
export default function ConVarAddBody({ open, close }) {
  const [connewbody, setConnewbody] = useState(false);
  const closeconnewbody = () => {
    setConnewbody(false);
  };
  ...
  return (
    <React.Fragment>
      ...
      <ContentNewBody isopen={connewbody} isclose={closeconnewbody} />
    </React.Fragment>
  );
}
