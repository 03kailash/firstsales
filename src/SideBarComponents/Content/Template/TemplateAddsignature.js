...
export default function TemplateAddsignature({ open, close }) {
  const [newsignature, setNewsignature] = useState(false);
  const closenewsignature = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <Box role="presentation">
          ...
          <div className="TempAddsignaturemaindiv">
            ...
            >
              Click on signature to add to the template
            </div>
      ...
      <TemplateNewsignature isopen={newsignature} isclose={closenewsignature} />
    </React.Fragment>
  );
}
