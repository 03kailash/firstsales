        ...
        <div style={{ display: 'flex', justifyContent: "space-between", width: '920px' }} >
          <div>
            ...
            <footer className=" footer-powerBy">
              ...
              <div className='Footer-Links-Link'>
                ...
                <a href='https://stripe.com/in/privacy' style={{ paddingLeft: '16px' }}>Privacy</a>
              </div>
            </footer>
          </div>
          <div className='paymentMethod'>
             ...
             {cardInfo && <div>
                <div>
                  ...
                  <div style={{ paddingTop: "10px", width: "100%" }}>
                    ...
                    >
                      <FormControl variant="standard" style={{ width: "100%" }}>
                        <BootstrapInput id="bootstrap-input" className='EmailFeildDiv' placeholder='1234 1234 1234 1234' />
                      </FormControl>
                      <div style={{ width: "100%", display: "flex", }}>
                        <FormControl variant="standard"  >
                          <BootstrapInput id="bootstrap-input" className='EmailFeildMM' placeholder='MM/YY' />
                        </FormControl>

                        <FormControl variant="standard"  >
                          <BootstrapInput id="bootstrap-input" className='EmailFeildCvv' placeholder='Cvv' />
                        </FormControl>
                      </div>
                    </Box>
                  </div>
                  ...
                  <div style={{ width: "100%", marginTop: '8px' }}>
                    <FormControl variant="standard" style={{ width: "100%" }}  >
                      <BootstrapInput id="bootstrap-input" className='EmailFeildDivv' />
                    </FormControl>
                  </div>
                </div>
                ...
                <div style={{ width: "100%", marginTop: '30px' }}>
                  <FormControl variant="standard" style={{ width: "100%" }}  >
                    <BootstrapInput id="bootstrap-input" className='ChaeckboxDiv'><Checkbox {...label} /></BootstrapInput>
                  </FormControl>
                  <FormControl variant="standard" style={{ width: "100%" }}  >
                    <BootstrapInput id="bootstrap-input" className='ChaeckboxxDiv' />
                  </FormControl>
                  <FormControl variant="standard" style={{ width: "100%" }}  >
                    <BootstrapInput id="bootstrap-input" className='ChaeckboxDivv' disabled />
                  </FormControl>
                </div>
              </div>}
             { bankInfo && <div>
                ...
                <div className="PaymentDivText">
                  Bank account
                <div className="Lock"><LockIcon style={{color:"rgb(20, 212, 51)",fontSize:"16"}}/><span className="Lock">Secured by Stripe</span></div>
                </div>

                <div style={{ width: "100%", marginTop: '8px' }}>
                  <FormControl variant="standard" style={{ width: "100%" }}   >
                    <BootstrapInput id="bootstrap-input" className='EmailFeildDivv' placeholder="Search for your bank" />
                  </FormControl>
                </div>
              </div>}
            </div>
            ...
            <div className='ConfirmPayment-PostSubmit'>
              After your trial ends, you will be charged US$149.00 per month starting 13 November 2022. You can always cancel before then.
            </div>
          </div>
        </div>
      </div>
