...
const columns = [
  { id: "Template", label: "Template", minWidth: "332px" },
...
export default function ChangeTemplate({open ,close}) {
    const [Createtemp, setCreatetemp] = useState(false);
    const closeCreatetemp = () => {
      setCreatetemp(false);
    };
  ...
  return (
    ...
    >
      <Box role="presentation">
        ...
        <div className="convaraddbodymaindiv">
          <div className="tempbuilderhead">Add Template</div>
          ...
          >
            Click on body block to add to the template
          </div>
    ...
    <CreateTemplate isopen={Createtemp} isclose={closeCreatetemp} />
  </React.Fragment>
  )
}
